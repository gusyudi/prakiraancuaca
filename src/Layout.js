...
export default class Cuaca extends React.Component {
  ...
  getWeather= () => {
    let url = 'http://api.openweathermap.org/data/2.5/weather?q=' + this.state.city + '&appid=659d4ccce25ca04d5d17c87329036363&units=metric';
    fetch (url)
  ...
  render() {
    ...
    <View style={styles.containerMain}>
      ...
      <View style={styles.box2}>
          <View style={{marginTop:20, marginLeft: 20, marginRight: 20, padding: 10, backgroundColor:'green'}}>
      ...
      <View style={styles.box1}>
          <Text style={{ textAlign: 'center', color: 'white', padding: 12, fontSize: 17 }} > copyright @gusyudi </Text>
      </View>
